...
\begin{abstract}
  AAAAAAAAAAAThe abstract paragraph should be indented \nicefrac{1}{2}~inch
...
\section{Example of citing references}
\label{sec:example-bib}

This is an example of citing references~\cite{nikolaidis2016formalizing}.
Another example~\cite{Floyd2015}.
